  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of transportation with ASDASDASD - your convenient, efficient car sharing solution. Find, book, and track vehicles in real-time, catering to all your diverse needs."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1485463611174-f302f6a5c1c9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjBzaGFyaW5nJTJDdHJhbnNwb3J0YXRpb258ZW58MHx8fHwxNjg5ODA3ODcyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of transportation with ASDASDASD - your convenient, efficient car sharing solution. Find, book, and track vehicles in real-time, catering to all your diverse needs.`}
            </Text>
            <Box
